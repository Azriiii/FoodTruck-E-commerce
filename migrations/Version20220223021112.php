 ...
 */
final class Version20220223021112 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product ADD quantite INT DEFAULT NULL, CHANGE category_id category_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product DROP quantite, CHANGE category_id category_id INT DEFAULT NULL');
