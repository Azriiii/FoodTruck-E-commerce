 ...
 */
final class Version20220222122922 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE reponse ADD status VARCHAR(55) NOT NULL, CHANGE id_reponse id_reponse INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE reponse DROP status, CHANGE id_reponse id_reponse INT DEFAULT NULL');
