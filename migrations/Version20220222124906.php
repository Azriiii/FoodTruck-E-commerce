 ...
 */
final class Version20220222124906 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE stocks ADD fournisseur_id INT NOT NULL, CHANGE qte_prod qte_prod INT DEFAULT NULL, CHANGE nom nom VARCHAR(49) DEFAULT NULL, CHANGE numerof numerof INT DEFAULT NULL, CHANGE prix_unitaire prix_unitaire INT DEFAULT NULL, CHANGE idprod idprod INT DEFAULT NULL');
        $this->addSql('ALTER TABLE stocks ADD CONSTRAINT FK_56F79805670C757F FOREIGN KEY (fournisseur_id) REFERENCES fournisseur (id)');
        $this->addSql('CREATE INDEX IDX_56F79805670C757F ON stocks (fournisseur_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_56F79805670C757F ON stocks');
        $this->addSql('ALTER TABLE stocks DROP fournisseur_id, CHANGE qte_prod qte_prod INT DEFAULT NULL, CHANGE nom nom VARCHAR(49) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE numerof numerof INT DEFAULT NULL, CHANGE prix_unitaire prix_unitaire INT DEFAULT NULL, CHANGE idprod idprod INT DEFAULT NULL');
    }
}
