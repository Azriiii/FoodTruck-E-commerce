 ...
 */
final class Version20220224130925 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE livreur CHANGE nom nom VARCHAR(44) DEFAULT NULL, CHANGE prenom prenom VARCHAR(55) DEFAULT NULL, CHANGE tel tel INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE stocks ADD stocks_id INT DEFAULT NULL, CHANGE qte_prod qte_prod INT DEFAULT NULL, CHANGE nom nom VARCHAR(49) DEFAULT NULL, CHANGE numerof numerof INT DEFAULT NULL, CHANGE prix_unitaire prix_unitaire INT DEFAULT NULL, CHANGE idprod idprod INT DEFAULT NULL');
        $this->addSql('ALTER TABLE stocks ADD CONSTRAINT FK_56F79805FACB6020 FOREIGN KEY (stocks_id) REFERENCES livreur (id)');
        $this->addSql('CREATE INDEX IDX_56F79805FACB6020 ON stocks (stocks_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE livreur CHANGE nom nom VARCHAR(44) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE prenom prenom VARCHAR(55) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE tel tel INT DEFAULT NULL');
        $this->addSql('ALTER TABLE product CHANGE category_id category_id INT DEFAULT NULL, CHANGE quantite quantite INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE reponse CHANGE id_reponse id_reponse INT DEFAULT NULL');
        $this->addSql('ALTER TABLE stocks DROP FOREIGN KEY FK_56F79805FACB6020');
        $this->addSql('DROP INDEX IDX_56F79805FACB6020 ON stocks');
        $this->addSql('ALTER TABLE stocks DROP stocks_id, CHANGE qte_prod qte_prod INT DEFAULT NULL, CHANGE nom nom VARCHAR(49) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE numerof numerof INT DEFAULT NULL, CHANGE prix_unitaire prix_unitaire INT DEFAULT NULL, CHANGE idprod idprod INT DEFAULT NULL');
    }
}
